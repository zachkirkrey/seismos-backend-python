...
CREATE TABLE default_val (
  ...
  fit_end_point int DEFAULT NULL,
  NG int DEFAULT NULL,
  breaker_YN int DEFAULT NULL,
  passion_method int DEFAULT NULL,
  plotraw_YN int DEFAULT NULL,
  use_wns_YN int DEFAULT NULL,
  fit_iteration int DEFAULT NULL,
  strat2 int DEFAULT NULL,
  stage_ques int DEFAULT NULL,
  soisson_var_YN int DEFAULT NULL,
  stress_shadow_YN int DEFAULT NULL,
  skip_losses_YN int DEFAULT NULL,
  poisson_var_YN int DEFAULT NULL,
  use_wncuts_YN int DEFAULT NULL,
  created_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY `PRIMARY` (id) USING HASH,
  KEY well_id (well_id) USING CLUSTERED COLUMNSTORE,
