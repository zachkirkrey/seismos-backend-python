...
CREATE TABLE chem_fluids (
  ...
  `second_to_last_bbls` int NULL,
  `second_to_last_description` varchar(50) NULL,
  `second_to_last_ppg` float NULL,

  `third_to_last_bbls` int NULL,
  `third_to_last_description` varchar(50) NULL,
  `third_to_last_ppg` float NULL,
...
CREATE TABLE stage (
  ...
  `designed_proppant` float NULL,
  `designed_pad_vol` int NULL,
  `designed_acid_vol` float NULL,
...
CREATE TABLE well (
  ...
  formation char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
