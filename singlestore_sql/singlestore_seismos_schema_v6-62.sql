...
DROP TABLE IF EXISTS fluids_item;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE fluids_item (
  id bigint NOT NULL AUTO_INCREMENT,
  `chem_fluids_id` int NOT NULL,
  `bbls` int NULL,
  `description` varchar(50) NULL,
  `ppg` float NULL,
  created_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY `PRIMARY` (id) USING HASH,
  KEY chem_fluids_id (chem_fluids_id) USING CLUSTERED COLUMNSTORE,
  SHARD KEY idx_SHARDKEY (id)
) AUTOSTATS_CARDINALITY_MODE=INCREMENTAL AUTOSTATS_HISTOGRAM_MODE=CREATE AUTOSTATS_SAMPLING=ON SQL_MODE='STRICT_ALL_TABLES';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE equipment (
  ...
  pressure_counter float DEFAULT NULL,
  created_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY `PRIMARY` (id) USING HASH,
  KEY id (id) USING CLUSTERED COLUMNSTORE,
...
CREATE TABLE perforation (
  ...
  `bottom_perf` float(255, 0) NULL,
  `top_perf` float(255, 0) NULL,
...
CREATE TABLE stage (
  ...
  `stage_end_time` BIGINT NULL,
  `frac_design` varchar(35) NULL,
  designed_acid_vol float,
  designed_proppant float,
  designed_total_clean_fluid_volume float NULL,
  designed_pad_vol float NULL,
  ...
  `designed_ pad_vol` int NULL,
  `designed_ total_clean_fluid_vol` int NULL,
...
CREATE TABLE active_data  (
  id int NOT NULL AUTO_INCREMENT,
  stage_id int NOT NULL,
  amplitude int NOT NULL DEFAULT 0,
  frequency float NOT NULL DEFAULT 0,
  offset int NOT NULL DEFAULT 0,
  period tinyint NOT NULL DEFAULT 0,
  wave_type varchar(50) NULL,
  post_frac_start_time bigint NULL,
  post_frac_end_time bigint NULL,
  pre_frac_start_time bigint NULL,
  pre_frac_end_time bigint NULL,
...
CREATE TABLE single_pulse_parameter  (
  ...
  t_trigger datetime NULL DEFAULT NULL,
  t_send float NULL DEFAULT NULL,
  t_ref_0 datetime NULL DEFAULT NULL,
...
CREATE TABLE single_pulse_nf_result  (
 id int UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  t_0 datetime NULL DEFAULT NULL,
