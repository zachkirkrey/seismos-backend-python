...
--
DROP TABLE IF EXISTS formation_fuild_injection;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE formation_fuild_injection (
  id bigint NOT NULL AUTO_INCREMENT,
...
breaker_YN Varchar(30)  DEFAULT NULL,
passion_method Varchar(30)  DEFAULT NULL,
plotraw_YN Varchar(30)  DEFAULT NULL,
use_wns_YN Varchar(30)  DEFAULT NULL,
fit_iteration Varchar(30)  DEFAULT NULL,
strat2 float DEFAULT NULL,
stage_ques float DEFAULT NULL,
poisson_var_YN Varchar(30)  DEFAULT NULL,
stress_shadow_YN Varchar(30)  DEFAULT NULL,
skip_losses_YN Varchar(30)  DEFAULT NULL,
use_wncuts_YN Varchar(30)  DEFAULT NULL,
  created_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY `PRIMARY` (id) USING HASH,
  KEY well_id (well_id) USING CLUSTERED COLUMNSTORE,
